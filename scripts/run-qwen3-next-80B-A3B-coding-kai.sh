...
# CKPT_ARGS=(
#    --hf-checkpoint /workspace/Qwen3-Next-80B-A3B-Thinking-FP8
#    #--hf-checkpoint /workspace/Qwen3-30B-A3B-FP8
#    --ref-load /workspace/Qwen3-Next-80B-A3B-Thinking-FP8_torch_dist
#    --load /workspace/Qwen3-Next-80B-A3B-Thinking-FP8_slime/test1
#    --save /workspace/Qwen3-Next-80B-A3B-Thinking-FP8_slime/test1
#    --save-interval 5
# )
